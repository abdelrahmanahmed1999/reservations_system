...
@section('content')
    ...
    <div class="row gx-3">
        ...
        <div class="col-lg-12 col-xl-12 col-xxl-12 h-100">
            ...
            <div class="col">
                <h5 class="mb-0 text-primary position-relative"><span class="bg-200 dark__bg-1100 pe-3">Editing Applicant</span><span class="border position-absolute top-50 translate-middle-y w-100 start-0 z-n1"></span></h5>
                @if(session('error'))
            ...
            <div class="card theme-wizard h-100 mb-5">
                ...
                <div class="card-body py-4" id="wizard-controller">
                    <form  id="applicantForm" method="POST"  action="{{ route('superadmin.applicant.update') }}" enctype="multipart/form-data">
                        @csrf
                                ...
                                <div class="" novalidate="novalidate" data-wizard-form="1">
                                    <div class="row">
                                        <div class="col-md-6 mb-2">
                                            ...
                                            <input class="form-control" type="text" name="name" value="{{$applicant->name}}" id="bootstrap-wizard-validation-wizard-name" />
                                            @error('name')
                                        ...
                                        <div class="col-md-6 ">
                                            ...
                                            <input type="email" class="form-control" rows="4" name="email" value="{{$applicant->email}}" id="email">
                                            @error('email')
                                                <label class="text-danger mt-1">{{ $message }}</label>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input name="picture_file" type="file" id="picture_file" class="dropify"
                                                    data-default-file="{{ URL::asset('images/applicants').'/'.$applicant->image }}"
