...
@section('content')
    ...
    <div class="row gx-3">
        ...
        <div class="col-lg-12 col-xl-12 col-xxl-12 h-100">
            ...
            <div class="col">
                <h5 class="mb-0 text-primary position-relative"><span class="bg-200 dark__bg-1100 pe-3">Adding Service</span><span class="border position-absolute top-50 translate-middle-y w-100 start-0 z-n1"></span></h5>
                @if(session('error'))
            ...
            <div class="card theme-wizard h-100 mb-5">
                ...
                <div class="card-body py-4" id="wizard-controller">
                    <form  id="applicantForm" method="POST"  action="{{ route('superadmin.service.insert') }}" enctype="multipart/form-data">
                        @csrf
                                ...
                                <div class="" novalidate="novalidate" data-wizard-form="1">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 ">
                                            ...
                                            <input type="description" class="form-control" rows="4" name="description" value="{{old('description')}}" id="description">
                                            @error('description')
                                                <label class="text-danger mt-1">{{ $message }}</label>
                                            @enderror
                                        </div>
